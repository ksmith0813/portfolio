        ...
        <Timeline mode='left'>
          ...
          <Timeline.Item label='12-27-1968' dot={<img src={moon} className='moon' alt='' />}>
            ...
            <p className='pt-100'>
              ...
              the Lunar Module was behind schedule and NASA wanted to maintain its launch schedule with the goal of
              attempting the first lunar landing in summer 1969. Because of that, and in light of the highly successful
              Apollo 7 mission, NASA made the audacious decision to send Apollo 8 to the Moon, despite that fact that it
              was only the second Apollo flight with a human crew and the third launch of the Saturn V booster rocket.
              The crew began training for a possible lunar mission in August 1968, but the final decision to fly to the
              Moon was not made until November 12, less than six weeks before launch. The goals of the mission included
